...
int main(void)
{
	...
	// WinSocket initializálás
	iResult = WSAStartup(MAKEWORD(2, 2), &wsaData);
	if (iResult != 0) {
		printf("WSAStartup failed with error: %d\n", iResult);
		return 1;
	}
	// Változó feltöltése 0-val
	...
	//Server socket-re nincs továbbá szükség, ezért bezárhatjuk
	closesocket(ListenSocket);

	//Addig fogadjuk az üzenetet amíg a kliens be nem zárja a kapcsolatot
	do {
